...
public class AppleTVPricingRule implements PricingRule {
    ...
    public static final int LEAST_BUYING_TV_NUM = 2;
    ...
    public BigDecimal apply(List<Item> items) {
        ...
        int chargeGroupSize = LEAST_BUYING_TV_NUM + FREE_TV_NUM;
        int numOfTvsForCharging =
                (numOfTvs / chargeGroupSize) * LEAST_BUYING_TV_NUM + (numOfTvs % chargeGroupSize);
